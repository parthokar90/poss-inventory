...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="p-5 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
            <h2 class="text-lg font-semibold text-gray-700 uppercase">Edit Customer Information</h2>
        ...
        <!-- Form Body -->
        <div class="p-6">
            <form action="{{ route('customer.update', $edit->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                @method('PATCH')
                ...
                <div>
                    ...
                    >{{ $edit->customer_address }}</textarea>
