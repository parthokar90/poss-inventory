         ...
         @include('admin.includes.messages')
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>PURCHASE REPORT OF PRODUCT</h2>
                        </div>
                          <div class="body">
                           <div class="text-center">
                                ...
                                <span style="font-weight: bold;">Purchase Report of product: {{$product->product_name}}</span><br>
                                    ...
                                    <tbody>
                                           ...
                                           @foreach($data as $key=>$item)
                                            <tr>
                                                ...
                                                <td>{{number_format($item->purchase_discount)}} Tk</td>
