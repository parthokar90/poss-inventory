...
@section('title', 'Dashboard | Supplier Purchase Report')
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-100">
        ...
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-700 uppercase">Supplier Purchase Report</h2>
        </div>

        <!-- Card Body -->
        <div class="p-6">
            
            <!-- Company Info & Supplier Filter Header -->
            <div class="text-center pb-6 mb-6 border-b border-gray-200 space-y-1">
                ...
                <div class="pt-3">
                    <span class="inline-block text-base font-semibold text-gray-800 uppercase tracking-wider">
                        Purchase Report of Supplier: 
                        <span class="text-indigo-600">
                            {{ optional(optional($data->first())->suppliers)->supplier_name ?? 'N/A' }}
                        </span>
                    </span>
                </div>
                    ...
                    <tbody class="divide-y divide-gray-200 text-xs text-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150 align-top">
                            ...
                            <td class="py-3 px-4 whitespace-nowrap">
                                @if(in_array(strtolower($item->status), ['paid', '1', 'completed']))
                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-emerald-100 text-emerald-800">
                                        {{ $item->status }}
                                    </span>
                                @elseif(in_array(strtolower($item->status), ['partial', 'pending']))
