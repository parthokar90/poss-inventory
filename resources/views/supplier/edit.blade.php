                          ...
                          <form action="{{route('supplier.update',$edit->id)}}" method="POST" enctype="multipart/form-data">
                             ...
                             {{ method_field('PATCH') }} 
                                 <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="supplier_name" autocomplete="off" value="{{$edit->supplier_name}}">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="email" class="form-control" name="supplier_email" autocomplete="off" value="{{$edit->supplier_email}}">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="supplier_phone" autocomplete="off" value="{{$edit->supplier_phone}}">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="supplier_address" cols="30" rows="5" maxlength="100" class="form-control no-resize">{{$edit->supplier_address}}</textarea>
