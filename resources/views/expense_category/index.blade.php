...
@section('title', 'Dashboard | Expense Category')
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-100">
        ...
        <div class="p-6 border-b border-gray-200 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <h2 class="text-lg font-semibold text-gray-700 uppercase">Expense Category Information</h2>

            <div class="flex flex-col sm:flex-row items-center gap-4">
                <!-- Search Form -->
                <form method="GET" action="{{ route('expense.index') }}" class="flex items-center w-full sm:w-auto">
                    <div class="relative w-full">
                        ...
                        <button type="submit" 
                                class="absolute right-0 top-0 h-full px-3 text-white bg-emerald-600 hover:bg-emerald-700 rounded-r-lg transition-colors duration-200 flex items-center justify-center">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-200 text-sm text-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="py-4 px-6 text-center">
                                <a href="{{ route('expense.edit', $item->id) }}" 
                                   title="Edit" 
                                   class="inline-block text-indigo-600 hover:text-indigo-900 transition-colors duration-150">
                    ...
                    @else
                        <tr>
                            <td colspan="4" class="py-6 px-6 text-center text-gray-500 font-medium">No Data Found</td>
                        </tr>
                    @endif
                </tbody>
            </table>
