                            ...
                            <h2>UNIT INFORMATION</h2>
                              <div class="form-group">
                                 <form method="get" action="{{route('units.index')}}">
                                     <input type="text" class="form-control" name="search" placeholder="Enter unit name to search" autocomplete="off" required>
                                         ...
                                         @if($list->count()>0)
                                           @foreach($list as $key=>$item)
                                            <tr>
                                                ...
                                                <td><a title="Edit Unit" href="{{route('units.edit',$item->id)}}"><i class="material-icons">edit</i></a></td>
                                            </tr>
                                            @endforeach 
                                         @else 
                                            No Data Found
